...
function updateProductSizes() {
    ...
    debugger;
    $.ajax({
        url: 'https://localhost:5001/api/Shop/' + productId,
        type: 'GET',
        dataType: 'json',
        success: function(sizes) {
            var sizeSelect = $('#ProductSize');
            sizeSelect.empty(); // پاک کردن گزینه‌های قبلی
...
function GetDiscountcode() {
   const apiUrl = 'https://localhost:5001/api/CodeGenerate';
